...
bool Level::save()
{
    ...
    levelFile.write(QString("%1 %2\n").arg(spawnX).arg(spawnY).toLocal8Bit());
...
bool Level::load(QString levelName)
{
    ...
    spawnX = spawnCoordinates.at(0).toInt();
    spawnY = spawnCoordinates.at(1).toInt();
    ...
    while(!reader.atEnd())
    {
        ...
        int newX = elementData.at(1).toInt();
        int newY = elementData.at(2).toInt();
